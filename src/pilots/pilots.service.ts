...
export class PilotsService {
    ...
    async create(createPilotDto: CreatePilotoDto) {
    ...
    async update(id: string, updatePilotDto: UpdatePilotoDto) {
        ...
        try {
          await piloto.updateOne(updatePilotDto);
          return { ...piloto.toJSON(), ...updatePilotDto };
        } catch (error) {
          this.handleException(error);
        }
      }
